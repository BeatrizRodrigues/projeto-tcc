...
module.exports = {
    ...
    async erode(req, res) {
        try{
            ...
            const imagem = await repository.erode(imageBase64, size1, size2, poin1, poin2, val, borderType);
    ...
    async dilate(req, res) {
        try{
            ...
            const imagem = await repository.dilate(imageBase64, size1, size2, poin1, poin2, val, borderType);
    ...
    async MorphologyEx(req, res) {
        try{
            ...
            const imagem = await repository.MorphologyEx(imageBase64, size1, size2, poin1, poin2, val, morphType, borderType);
